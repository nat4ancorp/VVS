...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2013 at 12:33 AM
...
('admin', 'b739d195ad7192bbd6a223a67645e3a766c239073667821cec0e07257f74410f', 'active', 'yes', '10.10.10.241', '.-471203.18021030891.71');
...
(2, 'The Harlem Shake v1 (TSCS original)', '384IUU43bfQ', '', 'youtube', 7, 7, 'active', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.'),
(3, 'Some other name that I do not know', '95vZ0-C1Kho', '', 'youtube', 7, 7, 'active', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.'),
...
(5, 'Test Kitten', 'testKITTEN.jpg', 'Nathan', 'image', 0, 0, 'active', 'I created a random image and this is the dummy text that goes along with it. '),
...
('10.10.10.241', '43828-81604.241800..11', 0, '0000-00-00');
